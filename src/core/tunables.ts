...
export const TUN = {
  ...
  phys: {
    /** global multiplier on every probe's Archimedes lift. */
    buoyancy: 1.0,
    /** vertical-velocity (heave) drag — near-critical so she rides, not porpoises.
     *  (was the hard-coded 2.8 in ship.ts round 14.) */
    heaveDamp: 2.8,
